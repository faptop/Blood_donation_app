    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Recipient_Activity.this,LoginActivity.class);
        ...
        registerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bloodgroup.equals("Select Your blood group")){
                    Toast.makeText(Recipient_Activity.this, "select Blood group", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                ...
                                Toast.makeText(Recipient_Activity.this, "Error"+error, Toast.LENGTH_SHORT).show();
                            }
                            else{
                                ...
                                userdatavaseref.updateChildren(userinfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(Recipient_Activity.this, "Data set successful", Toast.LENGTH_SHORT).show();
                                        }
                                        else {
                                            Toast.makeText(Recipient_Activity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                        finish();
                                ...
                                if(resulturi!=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(Recipient_Activity.this, "Image uploaded failed", Toast.LENGTH_SHORT).show();
                                        }
                                    });
...
//                                                        geting imageurl in Hashmap format
                                                        ...
                                                        userdatavaseref.updateChildren(newimagemap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(Recipient_Activity.this, "image url added to databse", Toast.LENGTH_SHORT).show();
                                                                }
                                                                else{
                                                                    Toast.makeText(Recipient_Activity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                    ...
                                    Intent intent=new Intent(Recipient_Activity.this,MainActivity.class);
                                    startActivity(intent);
                                    finish();
                                    loader.dismiss();
                                }
